<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true"
    CodeBehind="BrandProductList2.aspx.cs" Inherits="YoeJoyWeb.Pages.BrandProductList2" %>
...
<asp:Content ID="Content11" ContentPlaceHolderID="ScriptContent" runat="server">
        <script type="text/javascript">
            ...
            $(function () {
                ...
                var productIframeBaseURL = "BrandProductsResult2.aspx?&c1=" + c1 + "&c2=" + c2 + "&c3=" + c3 + "&bid=" + bid + "&attrIds=";
