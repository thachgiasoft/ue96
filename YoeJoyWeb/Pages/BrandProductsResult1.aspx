<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandProductsResult1.aspx.cs"
    Inherits="YoeJoyWeb.BrandProductsResult1" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var handlerBaseURL = "../Service/GetBrandProductList1Item.aspx";
        var order = "DESC";
        var orderOption = 1;
        ...
        function getProductListItem(callbackHandler) {
            ...
            var handlerURL = handlerBaseURL + "?startIndex=" + currentPageIndex + "&orderBy=" + orderOption + "&order="+order+"&bid=" + bid + "&random=" + Math.random();
