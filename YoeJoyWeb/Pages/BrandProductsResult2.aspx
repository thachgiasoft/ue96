<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandProductsResult2.aspx.cs"
    Inherits="YoeJoyWeb.BrandProductsResult2" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var handlerBaseURL = "../Service/GetBrandProductList2Item.aspx";
        var order = "DESC";
        var orderOption = 1;
        ...
        function getProductListItem(callbackHandler) {
            ...
            var handlerURL = handlerBaseURL + "?c1=" + c1 + "&c2=" + c2 + "&c3=" + c3 + "&startIndex=" + currentPageIndex + "&orderBy=" + orderOption + "&attrIds=" + attrIds + "&order=" + order + "&bid=" + bid + "&random=" + Math.random();
