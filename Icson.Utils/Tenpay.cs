...
namespace Icson.Utils
{
    ...
    public class Tenpay
    {
        ...
        /// 商户号（替换为自已的商户号）
        /// </summary>
        private const string bargainor_id = "1202007501";
        ...
        /// </summary>
        //private string return_url = "http://icson-mis.3322.org/Shopping/payresultfromTenpay.aspx";
        private string return_url = "http://www.baby1one.com.cn/Shopping/payresultfromTenpay.aspx";
        ...
        /// 可以使用相对地址或配置,在使用前拼装全地址就行.这样方便部署.
        /// </summary>
        private string queryreturn_url = "http://www.baby1one.com.cn/Shopping/queryresultfromTenpay.aspx";
