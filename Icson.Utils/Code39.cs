...
namespace Icson.Utils
{
	...
	public class Code39
	{
		...
		private string _c39FontFileName = ConfigurationManager.AppSettings["BarCodeFontFile"];
		private string _c39FontFamilyName = ConfigurationManager.AppSettings["BarCodeFontFamily"];		
