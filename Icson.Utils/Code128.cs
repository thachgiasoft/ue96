...
namespace Icson.Utils
{
    class Code128
    {
        ...
        private static string[] left_UPCA = new string[] {"0001101", "0	011001",	"0010011", "0111101", "0100011", "0110001", "0101111", "0111011"	, "0110	111", "0001011"};
        private static string[] right_UPCA = new string[] {"1110010", "	1100110"	, "1101100", "1000010", "1011100","1001110", "1010000", "1000100"	, "10010	00", "1110100"}; //1s compliment of left odd
        private static string[] both_2of5 = new string[] { "NNWWN", "WN	NNW", "N	WNNW", "WWNNN", "NNWNW", "WNWNN","NWWNN", "NNNWW", "WNNWN", "NWN	WN" };	
        ...
        "11011001100", "11001101100", "11001100110", "10010011000",	"100100	01100", "10001001100", "10011001000",
        "10011000100", "10001100100", "11001001000", "11001000100",	"110001	00100", "10110011100", "10011011100",
        "10011001110", "10111001100", "10011101100", "10011100110",	"110011	10010", "11001011100", "11001001110",
        "11011100100", "11001110100", "11101101110", "11101001100",	"111001	01100", "11100100110", "11101100100",
        "11100110100", "11100110010", "11011011000", "11011000110",	"110001	10110", "10100011000", "10001011000",
        "10001000110", "10110001000", "10001101000", "10001100010",	"110100	01000", "11000101000", "11000100010",
        "10110111000", "10110001110", "10001101110", "10111011000",	"101110	00110", "10001110110", "11101110110",
        "11010001110", "11000101110", "11011101000", "11011100010",	"110111	01110", "11101011000", "11101000110",
        "11100010110", "11101101000", "11101100010", "11100011010",	"111011	11010", "11001000010", "11110001010",
        "10100110000", "10100001100", "10010110000", "10010000110",	"100001	01100", "10000100110", "10110010000",
        "10110000100", "10011010000", "10011000010", "10000110100",	"100001	10010", "11000010010", "11001010000",
        "11110111010", "11000010100", "10001111010", "10100111100",	"100101	11100", "10010011110", "10111100100",
        "10011110100", "10011110010", "11110100100", "11110010100",	"111100	10010", "11011011110", "11011110110",
        "11110110110", "10101111000", "10100011110", "10001011110",	"101111	01000", "10111100010", "11110101000",
        "11110100010", "10111011110", "10111101110", "11101011110",	"111101	01110", "11010000100", "11010010000",
        "11010011100"		
        };		
...
while(code.Length < 11) // 11 is the length for upc-a barco	des;	
code = "0" + code;		
...
int barwidth = (int) Math.Floor((double) (width - 2 * paddi	ng) / ba	rbit.Length);
if(barwidth <= 0)		
barwidth = 1;		
if(centered)		
{		
...
for(int i = 1; i < 6; i++)		
{		
g.DrawString(code.Substring(i, 1), font, Brushes.Bl	ack, x +	(barwidth * 10) + padding + (spacing * (i - 1)), y + height - font.Height);
}		
for(int i = 6; i < 11; i++)		
{		
g.DrawString(code.Substring(i, 1), font, Brushes.Bl	ack, x +	(barwidth * 49) + padding + (spacing * (i - 6)), y + height - font.Height);
}		
...
{		
return "Code is not valid for an Interleaved 2 of 5 bar	code: "	+ code;
}		
		
if((checksum && IsEven(code.Length)) || (!checksum && IsOdd	(code.Le	ngth))) // check to make sure that the number of digits is even
code = "0" + code;		
...
for(int j = 0; j < 5; j++) // 5 is the width of all int	erleaved	symbologies
{		
if(black[j] == 'W')		
barbit += "11";		
else		
...
int barwidth = (int)Math.Floor((double)(width - 2 * padding	) / barb	it.Length);
if(barwidth <= 0)		
barwidth = 1;		
if(centered)		
{		
...
for(int i = 0; i < code.Length; i++)		
{		
g.DrawString(code.Substring(i, 1), font, Brushes.Bl	ack, x +	(barwidth * 10) + padding + (spacing * (i - 1)), y + height + 4);
}		
}		
return "";		
}		
...
int barwidth = (int)Math.Floor((double)(width - 2) / (barbi	t.Length	+ 20)); // add 20 for padding
if(barwidth <= 0)		
barwidth = 1;		
